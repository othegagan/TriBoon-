...
import { GrayUserIcon, GreenTickIcon } from "../../icons";
...
const AddNewUser = (props) => {
    ...
    const [idAssigned, setRole] = useState("");
    ...
    const handleInput = (e) => {
        ...
        if (data['role'] === 'Tester') {
            setRole('DEV' + Math.floor(new Date().valueOf() * (Math.floor(Math.random() * 10))).toString().substring(9));
        } else if (data['role'] === 'Developer') {
            setRole('TES' + Math.floor(new Date().valueOf() * (Math.floor(Math.random() * 10))).toString().substring(9));
        }
    ...
    const handleAdd = async (e) => {
        e.preventDefault();
        emailjs.sendForm('service_omb4xns', 'template_z4p1f3g', e.target, 'JIHuiTId8j2XGI5jh');
        try {
            await addDoc(collection(db, "users"), {
                ...data,
                "password": generatedPassword,
                "unique_id": idAssigned,
                    ...
                    <div className="pl-6 pr-6  dark:bg-gray-900 bg-gray-50 pb-6">
                        ...
                        <div className="mt-5 md:mt-0 md:col-span-2 dark:bg-gray-800">
                            <form onSubmit={handleAdd}>
                                            ...
                                            <div className=" flex flex-row items-center">
                                                <div className="shrink-1">
                                                    {file ?
                                                        ...
                                                        />
                                                        :
                                                        <GrayUserIcon className="w-12 h-12 " aria-hidden="true" />
                                                    }
                                                </div>
                                ...
                                <input type="text" name="pass" id="password" value={generatedPassword} readOnly hidden />
                                <input type="text" name="unq" id="unq" value={idAssigned} readOnly hidden />
                            </form>
                        </div>
                        ...
                        <Modal isOpen={isModalOpen} onClose={closeModal}>
                            <div className="flex flex-row items-center justify-left">
                                ...
                                <div className='ml-6 text-sm text-gray-700 dark:text-gray-100'>
                                    User Profile created successfully and login credentials as been sent to user.
                                </div>
                            </div>
                            <ModalFooter>
